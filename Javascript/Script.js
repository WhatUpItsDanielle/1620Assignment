...
Hiding notepad and making it re-apear:
* define hidden class (make cancel button, save button and notepad invisable)
* difine show class (make cancel button, save button and notepad show up)
